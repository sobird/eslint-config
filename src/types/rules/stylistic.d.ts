...
export interface StylisticRules {
   ...
   *
   * @see {@link https://eslint.style/rules/jsx-props-style exp-jsx-props-style}
   */
  "@stylistic/exp-jsx-props-style"?: ExpJsxPropsStyle;
  /**
