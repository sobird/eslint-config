 ...
 * @maxItems 2
 */
export type FileExtensionInImport = [
  "always" | "never",
  {
 ...
 * @maxItems 0
 */
export type NoCallbackLiteral = [];
/**
 * @minItems 1
 * @maxItems 1
 */
export type NoDeprecatedApi = [
  {
    version?: string;
    ignoreModuleItems?: (
      | "_linklist"
 ...
 * @maxItems 0
 */
export type NoExportsAssign = [];
/**
 * @minItems 1
 * @maxItems 1
 */
export type NoExtraneousImport = [
  {
    allowModules?: string[];
    convertPath?:
      | {
 ...
 * @maxItems 1
 */
export type NoExtraneousRequire = [
  {
    allowModules?: string[];
    convertPath?:
      | {
 ...
 * @maxItems 1
 */
export type NoRestrictedImport = [
  (
    | string
    | {
        name: string | string[];
 ...
 * @maxItems 1
 */
export type NoRestrictedRequire = [
  (
    | string
    | {
        name: string | string[];
 ...
 * @maxItems 1
 */
export type NoUnpublishedImport = [
  {
    allowModules?: string[];
    convertPath?:
      | {
 ...
 * @maxItems 1
 */
export type NoUnpublishedRequire = [
  {
    allowModules?: string[];
    convertPath?:
      | {
 ...
 * @maxItems 1
 */
export type PreferGlobalBuffer = ["always" | "never"];
/**
 * @minItems 1
 * @maxItems 1
 */
export type PreferGlobalConsole = ["always" | "never"];
/**
 * @minItems 1
 * @maxItems 1
 */
 ...
 * @maxItems 1
 */
export type PreferGlobalTextDecoder = ["always" | "never"];
/**
 * @minItems 1
 * @maxItems 1
 */
export type PreferGlobalTextEncoder = ["always" | "never"];
/**
 * @minItems 1
 * @maxItems 1
 */
export type PreferGlobalUrlSearchParams = ["always" | "never"];
/**
 * @minItems 1
 * @maxItems 1
 */
 ...
 * @maxItems 1
 */
export type PreferNodeProtocol = [
  {
    version?: string;
  }
];
 ...
 * @maxItems 0
 */
export type PreferPromisesDns = [];
/**
 * @minItems 0
 * @maxItems 0
 */
export type PreferPromisesFs = [];
/**
 * @minItems 0
 * @maxItems 0
 */
export type ProcessExitAsThrow = [];
/**
 * @minItems 1
 * @maxItems 1
 */
...
export interface NodeRules {
   ...
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/callback-return.md callback-return}
   */
  "n/callback-return"?: CallbackReturn;
  /**
   * enforce either `module.exports` or `exports`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/exports-style.md exports-style}
   */
  "n/exports-style"?: ExportsStyle;
  /**
   * enforce the style of file extensions in `import` declarations
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/file-extension-in-import.md file-extension-in-import}
   */
  "n/file-extension-in-import"?: FileExtensionInImport;
  /**
   * require `require()` calls to be placed at top-level module scope
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/global-require.md global-require}
   */
  "n/global-require"?: GlobalRequire;
  /**
   * require error handling in callbacks
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/handle-callback-err.md handle-callback-err}
   */
  "n/handle-callback-err"?: HandleCallbackErr;
  /**
   * enforce Node.js-style error-first callback pattern is followed
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-callback-literal.md no-callback-literal}
   */
  "n/no-callback-literal"?: NoCallbackLiteral;
  /**
   * disallow deprecated APIs
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-deprecated-api.md no-deprecated-api}
   */
  "n/no-deprecated-api"?: NoDeprecatedApi;
  /**
   * disallow the assignment to `exports`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-exports-assign.md no-exports-assign}
   */
  "n/no-exports-assign"?: NoExportsAssign;
  /**
   * disallow `import` declarations which import extraneous modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-extraneous-import.md no-extraneous-import}
   */
  "n/no-extraneous-import"?: NoExtraneousImport;
  /**
   * disallow `require()` expressions which import extraneous modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-extraneous-require.md no-extraneous-require}
   */
  "n/no-extraneous-require"?: NoExtraneousRequire;
  /**
   * disallow `import` declarations which import missing modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-missing-import.md no-missing-import}
   */
  "n/no-missing-import"?: NoMissingImport;
  /**
   * disallow `require()` expressions which import missing modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-missing-require.md no-missing-require}
   */
  "n/no-missing-require"?: NoMissingRequire;
  /**
   * disallow `require` calls to be mixed with regular variable declarations
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-mixed-requires.md no-mixed-requires}
   */
  "n/no-mixed-requires"?: NoMixedRequires;
  /**
   * disallow `new` operators with calls to `require`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-new-require.md no-new-require}
   */
  "n/no-new-require"?: NoNewRequire;
  /**
   * disallow string concatenation with `__dirname` and `__filename`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-path-concat.md no-path-concat}
   */
  "n/no-path-concat"?: NoPathConcat;
  /**
   * disallow the use of `process.env`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-process-env.md no-process-env}
   */
  "n/no-process-env"?: NoProcessEnv;
  /**
   * disallow the use of `process.exit()`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-process-exit.md no-process-exit}
   */
  "n/no-process-exit"?: NoProcessExit;
  /**
   * disallow specified modules when loaded by `import` declarations
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-restricted-import.md no-restricted-import}
   */
  "n/no-restricted-import"?: NoRestrictedImport;
  /**
   * disallow specified modules when loaded by `require`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-restricted-require.md no-restricted-require}
   */
  "n/no-restricted-require"?: NoRestrictedRequire;
  /**
   * disallow synchronous methods
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-sync.md no-sync}
   */
  "n/no-sync"?: NoSync;
  /**
   * disallow top-level `await` in published modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-top-level-await.md no-top-level-await}
   */
  "n/no-top-level-await"?: NoTopLevelAwait;
  /**
   * disallow `bin` files that npm ignores
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-unpublished-bin.md no-unpublished-bin}
   */
  "n/no-unpublished-bin"?: NoUnpublishedBin;
  /**
   * disallow `import` declarations which import private modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-unpublished-import.md no-unpublished-import}
   */
  "n/no-unpublished-import"?: NoUnpublishedImport;
  /**
   * disallow `require()` expressions which import private modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-unpublished-require.md no-unpublished-require}
   */
  "n/no-unpublished-require"?: NoUnpublishedRequire;
  /**
   * disallow unsupported ECMAScript built-ins on the specified version
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-unsupported-features/es-builtins.md no-unsupported-features/es-builtins}
   */
  "n/no-unsupported-features/es-builtins"?: NoUnsupportedFeaturesEsBuiltins;
  /**
   * disallow unsupported ECMAScript syntax on the specified version
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-unsupported-features/es-syntax.md no-unsupported-features/es-syntax}
   */
  "n/no-unsupported-features/es-syntax"?: NoUnsupportedFeaturesEsSyntax;
  /**
   * disallow unsupported Node.js built-in APIs on the specified version
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-unsupported-features/node-builtins.md no-unsupported-features/node-builtins}
   */
  "n/no-unsupported-features/node-builtins"?: NoUnsupportedFeaturesNodeBuiltins;
  /**
   * enforce either `Buffer` or `require("buffer").Buffer`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/buffer.md prefer-global/buffer}
   */
  "n/prefer-global/buffer"?: PreferGlobalBuffer;
  /**
   * enforce either `console` or `require("console")`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/console.md prefer-global/console}
   */
   ...
   */
  "n/prefer-global/process"?: PreferGlobalProcess;
  /**
   * enforce either `TextDecoder` or `require("util").TextDecoder`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/text-decoder.md prefer-global/text-decoder}
   */
  "n/prefer-global/text-decoder"?: PreferGlobalTextDecoder;
  /**
   * enforce either `TextEncoder` or `require("util").TextEncoder`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/text-encoder.md prefer-global/text-encoder}
   */
  "n/prefer-global/text-encoder"?: PreferGlobalTextEncoder;
  /**
   * enforce either `URLSearchParams` or `require("url").URLSearchParams`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/url-search-params.md prefer-global/url-search-params}
   */
  "n/prefer-global/url-search-params"?: PreferGlobalUrlSearchParams;
  /**
   ...
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-node-protocol.md prefer-node-protocol}
   */
  "n/prefer-node-protocol"?: PreferNodeProtocol;
  /**
   * enforce `require("dns").promises`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-promises/dns.md prefer-promises/dns}
   */
  "n/prefer-promises/dns"?: PreferPromisesDns;
  /**
   * enforce `require("fs").promises`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-promises/fs.md prefer-promises/fs}
   */
  "n/prefer-promises/fs"?: PreferPromisesFs;
  /**
   * require that `process.exit()` expressions use the same code path as `throw`
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/process-exit-as-throw.md process-exit-as-throw}
   */
  "n/process-exit-as-throw"?: ProcessExitAsThrow;
  /**
   * require correct usage of hashbang
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/hashbang.md hashbang}
   */
  "n/hashbang"?: Hashbang;
  /**
   * disallow third-party modules which are hiding core modules
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/no-hide-core-modules.md no-hide-core-modules}
   * @deprecated This rule is deprecated.
   */
  "n/no-hide-core-modules"?: NoHideCoreModules;
  /**
   * require correct usage of hashbang
   *
   * @see {@link https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/hashbang.md shebang}
   * @deprecated This rule is deprecated. It was replaced by n/hashbang.
   */
  "n/shebang"?: Shebang;
}
